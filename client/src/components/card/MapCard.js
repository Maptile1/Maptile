...
const TilesetCard = (props) => {
    ...
    return (
        <div class="max-w-sm rounded overflow-hidden shadow-lg border border-white bg-maptile-background-mid">
            <img class="w-full" src="https://images.gnwcdn.com/2020/usgamer/A-Link-to-the-Past-Map-Header1-05292020.jpg/EG11/thumbnail/1920x1080/format/jpg/quality/65/the-20-best-in-game-maps.jpg" alt="" onClick={() => handleTilesetView()} />
            <div class="px-6 py-4 ">
