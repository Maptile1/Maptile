...
const SplashScreen = (props) => {
    ...
    return (
        <div className="grid grid-cols-3 grid-rows-5 place-items-center h-screen w-full">
            <img className="col-start-2 row-start-2 mt-20 " alt="maptile" src={"maptile-logo.png"}>
            </img>
            <div className="col-start-1 col-span-3 row-start-4 bg-maptile-purple w-3/2 shadow-md rounded-lg">
